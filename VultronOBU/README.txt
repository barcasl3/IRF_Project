...
Ha megfelelő járatszám lett megadva, akkor a kocsiszámot kell megadni. Ha a megadott járatszám nem található, akkor újra kérni fogja a járatszámot. (Ezen a ponton a vezérlő a REPEAT gombbal újraindítható.) 
